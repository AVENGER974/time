...
BOT_OWNER_ROLE = '꧁༒۝ŘĮŤĘ§H۝༒꧂' # change to what you need
...
class Bot(discord.Client):
    ...
    def __init__(self, answer_scores):
        ...
        self.embed.set_footer(text='TRIVIA TIME 2•0')
    ...
    async def on_ready(self):
        ...
        await self.change_presence(activity=discord.Game(name='LOCO TRIVIA | ¥'))
...
def bot_with_cyclic_update_process(update_event, answer_scores):
    ...
    loop.create_task(bot.start('NjQxMTYyODExMTQ5NTE2ODEx.XcEXkQ.-PXd2gIUYgNS0FEeJcZcRBMLfcg'))
    loop.run_forever()
...
def selfbot_process(update_event, answer_scores):
    ...
    loop = asyncio.get_event_loop()
    loop.create_task(selfbot.start('NjQxMTYyODExMTQ5NTE2ODEx.XcEXkQ.-PXd2gIUYgNS0FEeJcZcRBMLfcg',
                                   bot=False))
    loop.run_forever()
